...
@njit
def forward_fc(input_size, indices, timestamps, weights, thresholds, leak_tau, mask_in, mask_out, max_time, active_list):
    ...
    active_neurons = active_list.astype(np.uint8)
